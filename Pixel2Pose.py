...
print('testing_time_total without loading'+str(testing_time))
...
ax.imshow(rgb_image)
ax.set_title('Reference RGB image')
...
cbar.ax.set_yticklabels(['1m', '2m', '3m'],{'fontsize':25}) 
ax.set_title('Output of Pixels2Depth')
ax.axis('off')
...
#ax.axis('off')
ax.view_init(10,-60)
ax.set_title('Output of Pixels2Pose')

plt.show()


print('Testing_time'+str(testing_time_withoutloading))
